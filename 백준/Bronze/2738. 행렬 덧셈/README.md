...
### 오답
 ...
 <p>행렬끼리 더할 때 간단하게 a+b를 하면 될 것이라고 생각하였으나, 아무런 라이브러리 없이 더하기만 하면 list a 뒤에 list b가 붙어서 출력된다. 따라서 라이브러리를 사용하지 않을 시에는 행과 열을 반복문을 사용하여 각 자리끼리 더해주어야 한다.</p>
